...
# log 관련 설정
ER_DATA_LOG_FILE = os.environ.get("ER_DATA_LOG_FILE", "./logs/collect_data_raw.log")
...
INIT_NICKNAME = os.environ.get("INIT_NICKNAME", "로컨")
WORKER_RULE = os.environ["WORKER_RULE"]
